let senators = [
    ...
    },
    {
        ...
        "extra": {
            ...
            "contact_form": "https://www.grassley.senate.gov/contact",
            "fax": "202-224-6020",
    ...
    },
    {
        ...
        "extra": {
            ...
            "contact_form": "https://www.murray.senate.gov/write-to-patty/",
            "fax": "202-224-0238",
    ...
    },
    {
        ...
        "extra": {
            ...
            "contact_form": "https://www.burr.senate.gov/contact",
            "fax": "202-228-2981",
    ...
    },
    {
        ...
        "extra": {
            ...
            "contact_form": "https://www.lankford.senate.gov/contact/email",
    ...
    },
    {
        ...
        "extra": {
            ...
            "contact_form": "https://www.rubio.senate.gov/public/index.cfm/contact",
            "fax": "202-228-0285",
    ...
    },
    {
        ...
        "extra": {
            ...
            "contact_form": "https://www.hoeven.senate.gov/public/index.cfm/email-the-senator",
            "fax": "202-224-7999",
    ...
    },
    {
        ...
        "extra": {
            ...
            "contact_form": "https://www.carper.senate.gov/public/index.cfm/email-senator-carper",
    ...
    },
    {
        ...
        "leadership_title": "Senate Democratic Policy & Communications Committee Chair",
        "party": "Democrat",
        "person": {
            "bioguideid": "S000770",
            "birthday": "1950-04-29",
    ...
    },
    {
        ...
        "extra": {
            ...
            "contact_form": "https://www.warnock.senate.gov/contact/",
            "how": "special-election",
            "office": "388 Russell Senate Office Building"
        },
        "leadership_title": null,
        "party": "Democrat",
        "person": {
...
function show_senators_info(array) {
    let table = document.querySelector('.table');  // сохраняю таблицу в переменную

    for (let i = 0; i < array.length; i++) {  // цикл перебирает сенаторов из списка
        let tr = document.createElement('tr');  // для каждого сенатора будет создаваться строка таблицы

        let name = document.createElement('td');
        let link = document.createElement('a');  // создаю ссылку
        link.innerHTML = array[i]['person']['name']  // в текст ссылки вписываю имя сенатора
        link.href = array[i]['person']['link']  // в href ссылки вставляю ссылку на сайт сенатора
        name.appendChild(link);

        let desc = document.createElement('td');
        desc.innerHTML = array[i]['description'];  // вставляю текст в ячейку из ключа 'descrtiption'

        let office = document.createElement('td');
        office.innerHTML = array[i]['extra']['office'];  // вставляю текст в ячейку из ключей extra->office

        let end = document.createElement('td');
        end.innerHTML = array[i]['enddate'];  // вставляю текст в ячейку из ключа enddate
        ...
        link2.href = 'https://twitter.com/' + array[i]['person']['twitterid'];
        twitter.appendChild(link2);

        tr.append(name, desc, office, end, phone, twitter);
        table.appendChild(tr);
    }
}
show_senators_info(senators);
