...
function create_table(array) {
    ...
    let tr0 = document.createElement('tr'); // создаю первую строчку в таблице
    for (let key in array[0]) {
        let th = document.createElement('th');  /* создаю заголовок таблицы */
        th.innerHTML = key;  /* текст заголовка - название ключа в объекте  */
        tr0.appendChild(th); // добавляю каждый заголовок в первую строчку
    }
